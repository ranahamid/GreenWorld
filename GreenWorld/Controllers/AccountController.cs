                ...
                if (result.Succeeded)
                {
                    ...
                    string body = "Dear " + model.Email + "," +
                       "\n\nWelcome to GreenWorld!" +
                        "\n\nA request has been received to open your GreenWorld account." +
                        "\n\nPlease confirm your account by clicking this link: <a href=\"" + callbackUrl + "\">Click here</a>." +

                        "\n\nIf you did not initiate this request, please contact us immediately at support@GreenWorld.com." +
                        "\n\nThank you," +
                        "\nThe GreenWorld Team.";
